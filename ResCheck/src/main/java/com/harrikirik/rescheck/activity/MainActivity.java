...
import com.harrikirik.rescheck.util.EdgeToEdgeSpec;
import com.harrikirik.rescheck.util.EdgeToEdgeUtil;
...
public class MainActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        EdgeToEdgeUtil.INSTANCE.applyPaddings(getWindow().getDecorView(), EdgeToEdgeSpec.Companion.getAVOID_BAR_AND_CUTOUT_SET_ALL(), false);
        EdgeToEdgeUtil.INSTANCE.setLightStatusBarIcons(getWindow());
